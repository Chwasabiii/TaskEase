    ...
    >
      <div className="glass-card" style={{ width: "100%", maxWidth: "440px", padding: "2rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem" }}>
          <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "1.2rem", fontWeight: 700, color: "#F1F5F9" }}>
            Collaboration
          </h2>
          <button
            onClick={onClose}
        ...
        {tab === "share" ? (
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            {task && (
              <p style={{ fontFamily: "var(--font-body)", fontSize: "0.8rem", color: "#475569" }}>
                Task: <span style={{ color: "#94A3B8" }}>{task.title}</span>
              </p>
            )}
          </div>
        ) : (
